...
img = st.image('Nifty_50_Logo.png')
...
if(infoType == 'Fundamental'):
    ...
    fundInfo = {
        ...
        'PEG Ratio' : info.get('peg Ratio', 0),
    ...
    fig.update_layout(
                title={
                    ...
                    'xanchor': 'center',
                    'yanchor': 'top'})
    st.plotly_chart(fig, width = "stretch", render_mode="svg")
    ...
    st.plotly_chart(figMA, width="stretch", render_mode="svg")
    ...
    st.plotly_chart(figMACD, width="stretch", render_mode="svg")
    ...
    st.plotly_chart(figBoll, width="stretch", render_mode="svg")
    ...
    st.write('Just a IT student who loves machine learning and I did this project as part of my study. Thank you!! ')
    st.write('My Accounts:')
    url = 'https://www.linkedin.com/in/jhanwi-kumari/'
    if st.button("LinkedIn"):
        webbrowser.open_new_tab(url)
    url1 = 'https://github.com/Jhanwi'
    if st.button("Github"):
